<template>
  <div class="shop-header">
    ...
    <div class="shop-content" v-if="shoplistone.logo">
      <img class="content-image" :src="`https://sqqproject.oss-cn-hangzhou.aliyuncs.com/`+ shoplistone.logo">
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
          <span class="content-name">{{shoplistone.shopname}}</span>
...
import {getShoplistone} from '@/api/index.js'
  export default {
    ...
    async mounted() {
      let result = await getShoplistone(this.id)
      this.shoplistone = result
      // console.log(result)
      // console.log(this.id)
    },
    methods: {
